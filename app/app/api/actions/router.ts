import {
  ...
  export const GET = async (req: Request) => {
    try {
      ...
      const payload: ActionGetResponse = {
        type: 'action',
        title: 'Donate SOL to Dev Cat',
        icon: 'https://ucarecdn.com/6d7a11cf-b899-4307-ba45-004464cf24c0/-/preview/1000x1000/',
        description:
          'Solana Developer for Public Good | Support my work with a donation.',
  ...
  export const POST = async (req: Request) => {
    try {
      ...
      const payload: ActionPostResponse = await createPostResponse({
        fields: {
          transaction,
          message: `Sent ${amount} SOL to Dev Cat: ${toPubkey.toBase58()}`,
        },
  ...
  function validatedQueryParams(requestUrl: URL) {
    let toPubkey: PublicKey = new PublicKey(
      '4isWokELe6jFC2R5e3xDsvoEMjH7cnVKDfyPDdKRxLMk',
    );
